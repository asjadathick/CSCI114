...
int main()
{
    ...
    for (int i=1; i<=13 && successfulInput==true; i++)
    {
        ...
        firstSix(diceValues,scores);
        //3 of a kind
        scores[6]=ofaKind(diceValues,3);
        //4 of a kind
        scores[7]=ofaKind(diceValues,4);

        //full house
        scores[8]=fullHouse(diceValues);
        //small straight
        scores[9]=smallStraight(diceValues);
        //large straight
        scores[10]=largeStraight(diceValues);
        //yahtzee
        scores[11]=yahtzee(diceValues);
        //chance
        scores[12]=chance(diceValues);
