...
int main()
{
	...
	for (int i=1; i<=13;i++)
	{
		...
		//initialize int array dicevalues
...
void reRollDice(int diceValues[]) //functional
{
	...
	cout<<"What re-rolls? \t";
	cin.clear(); //to ensure the stream isn't bad from the previous input
